...
describe("guided workflow", () => {
    it("loads current step, workflow, and referenced files", async () => {
        ...
        expect(context.requiredFiles.map((item) => item.file)).toEqual(expect.arrayContaining([
            "01_立项设定/创作目标.md",
            "01_立项设定/故事卖点.md",
            "01_立项设定/读者承诺.md",
            "01_立项设定/不写什么.md"
    ...
    it("reports downstream impact for author edits", () => {
        ...
        expect(impact.affectedArtifacts).toEqual(expect.arrayContaining(["03_大纲", "04_伏笔与期待", "05_前情与状态", "06_章节规划", "07_正文", "08_AI审稿"]));
    });
});
